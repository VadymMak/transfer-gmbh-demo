...
export async function generateMetadata() {
  return { title: 'Ochrana osobných údajov | Euroschnell', robots: { index: false } };
}
    ...
    <main className={styles.legal}>
      <div className={styles.legal__inner}>
        ...
        <section className={styles.legal__section}>
          ...
          Východná 2336/13, 911 08 Trenčín, Slovensko<br />
        ...
        <section className={styles.legal__section}>
          <h2>6. Vaše práva</h2>
          <p>Máte právo na prístup k údajom, ich opravu, vymazanie, obmedzenie spracúvania a na prenosnosť údajov. V týchto veciach nás kontaktujte na: info@euroschnell.eu</p>
        </section>

...
const CONTENT: Record<string, Content> = {
  sk: {
    ...
    s6h: '6. Vaše práva',
    s6b: 'Máte právo na prístup k údajom, ich opravu, vymazanie, obmedzenie spracúvania a na prenosnosť údajov. V týchto veciach nás kontaktujte na: info@euroschnell.eu',
  ...
  cs: {
    ...
    s6h: '6. Vaše práva',
    s6b: 'Máte právo na přístup k údajům, jejich opravu, výmaz, omezení zpracování a na přenositelnost údajů. V těchto věcech nás kontaktujte na: info@euroschnell.eu',
    s7h: '7. Právo podat stížnost',
    s7b: 'Máte právo podat stížnost dozorovému úřadu — Úřad na ochranu osobných údajů Slovenské republiky (dataprotection.gov.sk).',
  },
  de: {
    ...
    s6h: '6. Ihre Rechte',
    s6b: 'Sie haben das Recht auf Auskunft, Berichtigung, Löschung, Einschränkung der Verarbeitung sowie Datenübertragbarkeit. Wenden Sie sich hierzu an: info@euroschnell.eu',
  ...
  en: {
    ...
    s6h: '6. Your rights',
    s6b: 'You have the right to access, rectification, erasure, restriction of processing and data portability. For these matters, contact us at: info@euroschnell.eu',
  ...
  ru: {
    ...
    s6h: '6. Ваши права',
    s6b: 'Вы имеете право на доступ к данным, их исправление, удаление, ограничение обработки и на переносимость данных. По этим вопросам обращайтесь: info@euroschnell.eu',
  ...
  uk: {
    ...
    s6h: '6. Ваші права',
    s6b: 'Ви маєте право на доступ до даних, їх виправлення, видалення, обмеження обробки та на перенесення даних. З цих питань звертайтеся: info@euroschnell.eu',
    ...
    <main className={styles.legal}>
      <div className={styles.legal__inner}>
        ...
        <section className={styles.legal__section}>
          ...
          Východná 2336/13, 911 08 Trenčín<br />

...
const CONTENT: Record<string, Content> = {
  sk: {
    ...
    activity: 'Osobná cestná doprava — taxislužba, osobný a skupinový transfer. Licencovaný prevádzkovateľ osobnej dopravy.',
  ...
  cs: {
    ...
    activity: 'Osobní silniční doprava — taxislužba, osobní a skupinový transfer. Licencovaný provozovatel osobní dopravy.',
  ...
  de: {
    ...
    activity: 'Personenbeförderung im Straßenverkehr — Taxidienst, Einzel- und Gruppentransfer. Lizenzierter Personenbeförderer.',
  ...
  en: {
    ...
    activity: 'Passenger road transport — taxi service, individual and group transfers. Licensed passenger transport operator.',
  ...
  ru: {
    ...
    activity: 'Пассажирские автомобильные перевозки — такси, индивидуальный и групповой трансфер. Лицензированный оператор пассажирских перевозок.',
  ...
  uk: {
    ...
    activity: 'Пасажирські автомобільні перевезення — таксі, індивідуальний і груповий трансфер. Ліцензований оператор пасажирських перевезень.',

...
export async function generateMetadata({
  ...
  const titles: Record<string, string> = {
    de: 'Flughafentransfer Wien ⇄ Bratislava | Euroschnell',
    sk: 'Letiskový transfer Viedeň ⇄ Bratislava | Euroschnell',
    cs: 'Letištní transfer Vídeň ⇄ Bratislava | Euroschnell',
    en: 'Airport Transfer Vienna ⇄ Bratislava | Euroschnell',
  };
  ...
  return {
    ...
    openGraph: {
      ...
      locale: ogLocale,
      type: 'website',
      images: [{ url: ogImage, width: 1200, height: 630, alt: 'Euroschnell' }],
    },
    twitter: {
...
export default async function LocaleLayout({
  ...
  const jsonLdRaw: Record<string, unknown> = {
    ...
    // taxID (DIČ) omitted — business is not VAT-registered; TODO_FROM_GOOGLE if status changes
    areaServed: [
      { '@type': 'City', name: 'Wien' },

      ...
      <div className="footer__inner">
        ...
        <div className="footer__brand">
          ...
          <div className="footer__socials">
            ...
            {presence.telegram && (
              <a href={presence.telegram} target="_blank" rel="noopener" aria-label="Telegram" className="footer__social-link">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.447 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.333-.373-.12L7.22 13.617 4.26 12.71c-.646-.203-.66-.646.136-.956l11.12-4.29c.538-.194 1.01.131.838.956-.003-.001-.42.002-.42.002z"/>
                </svg>
              </a>
            )}

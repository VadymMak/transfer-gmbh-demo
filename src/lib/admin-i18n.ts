...
export interface AdminTranslations {
  ...
  promotions: {
    ...
    typeDiscount: string;
    typeServiceOfDay: string;
    typeBanner: string;
    typeFreeDelivery: string;
  };
  orders: {
    title: string;
    export: string;
...
const SK: AdminTranslations = {
  ...
  promotions: {
    ...
    createTitle:       'Vytvoriť akciu',
    editTitle:         'Upraviť akciu',
    nameLabel:         'Názov akcie',
    discountPctLabel:  'Zľava, %',
    promoCodeLabel:    'Promokód',
    descriptionLabel:  'Popis / Oznam',
    startDateLabel:    'Dátum začiatku',
    endDateLabel:      'Dátum konca',
    saveBtn:           'Uložiť',
    cancelBtn:         'Zrušiť',
    editBtn:           'Upraviť',
    deleteBtn:         'Zmazať',
    statusActive:      'Aktívna',
    statusScheduled:   'Naplánovaná',
    statusFinished:    'Ukončená',
    typeDiscount:      'Zľava na službu',
    typeServiceOfDay:  'Služba dňa',
    typeBanner:        'Oznámenie',
    typeFreeDelivery:  'Špeciálna ponuka',
  },
  orders: {
    title:             'Objednávky',
    export:            'Export Excel',
...
const EN: AdminTranslations = {
  ...
  promotions: {
    ...
    nameLabel:         'Promotion title',
    discountPctLabel:  'Discount, %',
    promoCodeLabel:    'Promo code',
    descriptionLabel:  'Description / Announcement',
    ...
    typeDiscount:      'Service discount',
    typeServiceOfDay:  'Service of the day',
    typeBanner:        'Announcement',
    typeFreeDelivery:  'Special offer',
  },
  orders: {
    title:             'Orders',
    export:            'Export Excel',
...
const CS: AdminTranslations = {
  ...
  promotions: {
    ...
    discountPctLabel:  'Sleva, %',
    promoCodeLabel:    'Promo kód',
    descriptionLabel:  'Popis / Oznámení',
    startDateLabel:    'Datum začátku',
    endDateLabel:      'Datum konce',
    saveBtn:           'Uložit',
    cancelBtn:         'Zrušit',
    editBtn:           'Upravit',
    deleteBtn:         'Smazat',
    ...
    statusScheduled:   'Naplánovaná',
    statusFinished:    'Ukončená',
    typeDiscount:      'Sleva na službu',
    typeServiceOfDay:  'Služba dne',
    typeBanner:        'Oznámení',
    typeFreeDelivery:  'Speciální nabídka',
  },
  orders: {
    title:             'Objednávky',
    export:            'Export Excel',
...
const DE: AdminTranslations = {
  ...
  promotions: {
    ...
    createTitle:       'Aktion erstellen',
    editTitle:         'Aktion bearbeiten',
    nameLabel:         'Titel der Aktion',
    discountPctLabel:  'Rabatt, %',
    promoCodeLabel:    'Promo-Code',
    descriptionLabel:  'Beschreibung / Ankündigung',
    ...
    typeDiscount:      'Rabatt auf Service',
    typeServiceOfDay:  'Tagesservice',
    typeBanner:        'Ankündigung',
    typeFreeDelivery:  'Sonderangebot',
  },
  orders: {
    title:             'Bestellungen',
...
const UK: AdminTranslations = {
  ...
  promotions: {
    ...
    editTitle:         'Редагувати акцію',
    nameLabel:         'Назва акції',
    discountPctLabel:  'Знижка, %',
    promoCodeLabel:    'Промокод',
    descriptionLabel:  'Опис / Оголошення',
    ...
    statusScheduled:   'Запланована',
    statusFinished:    'Завершена',
    typeDiscount:      'Знижка на послугу',
    typeServiceOfDay:  'Послуга дня',
    typeBanner:        'Оголошення',
    typeFreeDelivery:  'Спеціальна пропозиція',
  },
  orders: {
    title:             'Замовлення',
...
const RU: AdminTranslations = {
  ...
  promotions: {
    ...
    createTitle:       'Создать акцию',
    editTitle:         'Редактировать акцию',
    nameLabel:         'Название акции',
    discountPctLabel:  'Скидка, %',
    promoCodeLabel:    'Промокод',
    descriptionLabel:  'Описание / Объявление',
    ...
    statusScheduled:   'Запланированная',
    statusFinished:    'Завершённая',
    typeDiscount:      'Скидка на услугу',
    typeServiceOfDay:  'Услуга дня',
    typeBanner:        'Объявление',
    typeFreeDelivery:  'Специальное предложение',
  },
  orders: {
    title:             'Заказы',
...
const PL: AdminTranslations = {
  ...
  promotions: {
    ...
    createTitle:       'Utwórz promocję',
    editTitle:         'Edytuj promocję',
    nameLabel:         'Tytuł promocji',
    discountPctLabel:  'Rabat, %',
    promoCodeLabel:    'Kod promocyjny',
    descriptionLabel:  'Opis / Ogłoszenie',
    ...
    typeDiscount:      'Rabat na usługę',
    typeServiceOfDay:  'Usługa dnia',
    typeBanner:        'Ogłoszenie',
    typeFreeDelivery:  'Oferta specjalna',
  },
  orders: {
    title:             'Zamówienia',
